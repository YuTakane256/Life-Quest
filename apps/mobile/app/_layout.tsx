...
import { startAuthSessionListener, startMobileAuthLinkListener } from '../src/platform/auth';
...
export default function RootLayout() {
    ...
    // Auth links use separate validation for recovery and Google OAuth callbacks.
    useEffect(() => startMobileAuthLinkListener(), []);
