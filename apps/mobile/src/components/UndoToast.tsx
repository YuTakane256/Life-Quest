...
const styles = StyleSheet.create({
    ...
    message: { flex: 1, color: theme.text.primary, fontSize: 13, fontWeight: '600' },
    action: { paddingHorizontal: 10, paddingVertical: 6, borderRadius: 8, backgroundColor: theme.accent.primary },
    pressed: { opacity: 0.7 },
